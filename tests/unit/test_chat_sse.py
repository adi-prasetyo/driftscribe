...
async def _stub_stream(prompt, session_id=None, *, workload="drift", autonomy_mode="propose_apply", prior_turns=None, demo_anon=False, denied_tools=None):
...
async def _stub_stream_with_iac_pr(prompt, session_id=None, *, workload="drift", autonomy_mode="propose_apply", prior_turns=None, demo_anon=False, denied_tools=None):
    yield {"type": "event", "event": {
...
def test_chat_sse_rebinds_contextvars_for_the_stream_body(_adk_enabled):
    ...
    async def _ctx_echo_stream(prompt, session_id=None, *, workload="drift", autonomy_mode="propose_apply", prior_turns=None, demo_anon=False, denied_tools=None):
        yield {"type": "event", "event": {
...
def test_chat_sse_emits_error_frame_on_inloop_failure(_adk_enabled):
    async def _boom(prompt, session_id=None, *, workload="drift", autonomy_mode="propose_apply", prior_turns=None, demo_anon=False, denied_tools=None):
...
async def _stub_stream_with_token(prompt, session_id=None, *, workload="drift", autonomy_mode="propose_apply", prior_turns=None, demo_anon=False, denied_tools=None):
    yield {"type": "event", "event": {
