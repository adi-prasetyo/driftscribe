...
async def _stub_chat(prompt, session_id=None, *, workload="drift"):
...
def test_chat_provision_does_not_invoke_run_chat_stream(_adk_enabled):
    ...
    def _forbidden_chat_stream(prompt, session_id=None, *, workload="drift"):
...
def test_chat_drift_json_still_goes_through_run_chat_not_fanout(_adk_enabled):
    ...
    async def _spy_fanout(prompt, session_id=None):
        fanout_called()
