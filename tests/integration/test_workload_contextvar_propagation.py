...
def test_chat_drift_propagates_workload_to_mcp_log(caplog):
    ...
    async def stub_run_chat(prompt: str, *, session_id=None, workload: str = "drift", autonomy_mode: str = "propose_apply", prior_turns=None, demo_anon=False, denied_tools=None):
