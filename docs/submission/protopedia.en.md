...
- LLM: Gemini 3.5 Flash on Vertex AI at `thinking_level=high` (`GOOGLE_CLOUD_LOCATION=global`, the endpoint this Gemini 3 model is served on and where the coordinator receives reasoning summaries; Cloud Run itself runs in asia-northeast1)
