...
_EXPLORE_DEMO_ANON_NOTE = (
    ...
    "requests. A scheduled reset periodically restores the baseline, so drift "
    "that was resolved can reappear, and an adoption pull request a visitor "
    "opened may be closed automatically after a couple of hours. This is "
